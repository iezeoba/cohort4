import functions from "./fetch_2.js";
...
const me = [
    {
        ...
        "company": {
            "name": "Lightco",
            "catchPhrase": "Acquired dynamic control systems",
...
test('Testing getAllFirstNames', () => {  //should return an array of first names
    expect(functions.getAllFirstNames(data)).toEqual(['Leanne Graham',
        ...
        'Glenna Reichert',
        'Clementina DuBuque']);
    expect(functions.getAllFirstNames(me)).toEqual(["Ifeanyi Ezeoba",
        "Michael Dualroyalty"]);
});
